...
class Circuit
  attr_accessor :wires_with_unknown_signal
  ...
  def privide_signal_to_wire(id, signal)
    @wires_with_unknown_signal[id] = signal
  end
...
circuit.wires_with_unknown_signal['b'].input = 956
circuit.run_circuit
